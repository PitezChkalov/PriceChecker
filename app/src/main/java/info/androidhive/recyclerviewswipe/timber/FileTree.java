package info.androidhive.recyclerviewswipe.timber;
...
public class FileTree extends Timber.DebugTree {
    private static final String LOG_TAG = FileTree.class.getSimpleName();
    ...
    private static File generateFile(@NonNull String path, @NonNull String fileName) {
        ...
        if (isExternalStorageAvailable()) {
            File root = new File(MyApplication.appPath,
